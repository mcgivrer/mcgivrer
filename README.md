...
- **2025-01-02** A new coming tool is a bash script to initialize a java project, with some template files from a gist. The [Java Init 1.4]([https://gist.github.com/mcgivrer/c4a65916809f07915c5b7cfcb93422ed](https://gist.github.com/mcgivrer/2770cf06be8702789b2f320c3274de60) "go and look at this gist") script will create a java application with the latest [build scripts]( "curious about this ?") and a generic batch java application from [this java template batch app gist](https://gist.github.com/mcgivrer/c4a65916809f07915c5b7cfcb93422ed "template is life, go and test it !").
